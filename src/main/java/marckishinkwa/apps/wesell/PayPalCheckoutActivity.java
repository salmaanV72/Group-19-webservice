...
import marckishinkwa.apps.wesell.jsonEntityObjects.PaymentResponseObject;
import marckishinkwa.apps.wesell.jsonEntityObjects.ServerObject;
import marckishinkwa.apps.wesell.network.GsonRequest;
import marckishinkwa.apps.wesell.network.VolleySingleton;
